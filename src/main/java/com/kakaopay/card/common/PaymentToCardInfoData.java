...
public class PaymentToCardInfoData {
    ...
    public static String doChangePaymentToCardInfoData(Payment payment) {
        ...
        sb
                ...
                .append(StringUtils.rightPad("PAYMENT", i_dataType, " "))
                ...
                .append(StringUtils.leftPad(payment.getAmount(), i_amount, " "))
                .append(StringUtils.leftPad(payment.getVat(), i_vat, "0"))
                // 원거래관리번호 (취소건일경우에만 적재)
                .append(StringUtils.leftPad(" ", i_orgPaymentId, " "))
                // 암호화된 카드정보
                .append(StringUtils.rightPad("encrpytInfo", i_encryptInfo, " "))
                // 예비 필드
